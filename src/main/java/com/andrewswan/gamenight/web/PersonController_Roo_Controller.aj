...
import com.andrewswan.gamenight.web.PersonController;
...
privileged aspect PersonController_Roo_Controller {
    ...
    public String PersonController.create(@Valid Person person, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
        ...
        uiModel.asMap().clear();
        person.persist();
        return "redirect:/person/" + encodeUrlPathSegment(person.getId().toString(), httpServletRequest);
    }
    ...
    void PersonController.addDateTimeFormatPatterns(Model uiModel) {
        uiModel.addAttribute("person_dateregistered_date_format", DateTimeFormat.patternForStyle("S-", LocaleContextHolder.getLocale()));
    }
